...
- 서로 대응하는 질문과 텍스트의 유사도는 키우고, 그렇지 않은 질문과 텍스트의 유사도는 낮추는 방식으로 학습합니다.
  - Batch Size가 3일 때, 두 인코더의 임베딩으로 (3 x 768) * (768 x 3) = (3 x 3)의 **Similarity Matrix**를 만들 수 있습니다.
  - **Similarity Matrix의 주대각선**이 서로 대응하는 질문과 텍스트의 유사도에 해당합니다.
...
- 이상의 방법으로 학습된 두 인코더를 이용해 **질문과 유사도가 가장 큰 텍스트를 추출하는 방식**으로 검색이 가능합니다.               
